...
public class RequestSRandMember extends RequestWithKey {
    /**
     ...
     * Constructor.
     *
     * @param tokens The different words of the request, e.g {"srandmember", "key"}.
     ...
     */
    public RequestSRandMember(ArrayList<String> tokens) throws InvalidNbArgException, NoTokensException {
        super(tokens);
        setNbArgs(minNbArgs);
        parse();
    }
