...
public class RequestSUnion extends Request {
    /**
     ...
     * Constructor.
     *
     * @param tokens The different words of the request, e.g {"sunion", "key", "key2", ...}.
     ...
     */
    public RequestSUnion(ArrayList<String> tokens) throws NoTokensException, InvalidNbArgException {
        super(tokens);
        setNbArgs(minNbArgs);
        parse();
    }
    ...
    public void parse() throws InvalidNbArgException {
        ...
        /* sublist because we skip "sunion" */
    ...
    /**
     * Get all the keys we want to union
     * @return all the keys we want to union
     */
