...
public class RequestSMembers extends RequestWithKey {
    /**
     ...
     * Constructor.
     *
     * @param tokens The different words of the request, e.g {"smembers", "key"}.
     ...
     */
    public RequestSMembers(ArrayList<String> tokens) throws InvalidNbArgException, NoTokensException {
        super(tokens);
        setNbArgs(minNbArgs);
        parse();
    }
