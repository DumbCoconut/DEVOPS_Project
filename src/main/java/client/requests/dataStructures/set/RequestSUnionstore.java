...
public class RequestSUnionstore extends Request {
    /**
     ...
     * Constructor.
     *
     * @param tokens The different words of the request, e.g {"sunionstore", "keydst", "key", "key2", ...}.
     ...
     */
    public RequestSUnionstore(ArrayList<String> tokens) throws NoTokensException, InvalidNbArgException {
        super(tokens);
        setNbArgs(minNbArgs);
        parse();
    }
